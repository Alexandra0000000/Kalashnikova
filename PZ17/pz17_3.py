...
os.chdir(r'/home/student/Документы/clone/PZ11')
...
# os.chdir(r'/home/student/Документы/clone')
# os.makedirs('test/test1')
# os.replace(r'PZ6/PZ6_1.py', 'test/PZ6_1.py')
# os.replace(r'PZ6/PZ6_2.py', 'test/PZ6_2.py')
# os.replace(r'PZ7/pz7_2.py', 'test/test1/test.txt')
#
...
pdf_file = r'/home/student/Документы/clone/reports/pract13.pdf'
subprocess.call(['xdg-open', pdf_file])


# 5. удалить файл test.txt.

file = r'/home/student/Документы/clone/test/test1/test.txt'
